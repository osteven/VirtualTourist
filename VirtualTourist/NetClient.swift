...
class NetClient {
    ...
    // MARK: - Public Flickr API calls
    func initFlickrPhotoListSearch(desiredPage: Int, desiredPhotosPerPage: Int, region: MKCoordinateRegion, completionHandler: TaskRequestClosure) {
        let methodArguments = [
    ...
    func getOneFlickrPhoto(urlString: String, session: NSURLSession,
        completionHandler: TaskRequestClosure) {
    ...
    func initFlickrCommentSearch(photoID: String, completionHandler: TaskRequestClosure) {
        let methodArguments = [
